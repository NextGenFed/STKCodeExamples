...
REM docker run -it -v c:/Temp:C:/TempHost --name stk-baseline --env-file ..\configuration\licensing.env --rm ansys/stk/stk-engine-baseline:12.5.0-windowsserver-ltsc2022 cmd.exe

docker run -it -v c:/Temp:C:/TempHost --name stk-baseline --env-file ..\configuration\licensing.env --rm ansys/stk/stk-engine-baseline:12.5.0-server2022-ogc cmd.exe
